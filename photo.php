...
function select_photo($string, $hash){
    if($string){
        ...
        if($res == "png"){
            //echo $res."<br>";
            echo "<div><a href='download.php?file={$hash}'><img width='80px' height='80px' src='users_file/root/{$string}'></img></a>";
            echo "<a href='del.php?del={$hash}'>del</a></div>";
        }
        if($res == "jpg"){
            //echo $res."<br>";
            echo "<div><a href='download.php?file={$hash}'><img width='80px' height='80px' src='users_file/root/{$string}'></img></a>";
...
echo "<form class='form-input' method='post' action='http://92.253.206.13/upload.php' enctype='multipart/form-data'>
