...
function select_photo($string, $hash){
    if($string){
        ...
        if($res == "png"){
            //echo $res."<br>";
            echo "<div><a href='../icloud/download.php?file={$hash}'><img width='80px' height='80px' src='../users_file/root/{$string}'></img></a>";
            echo "<a href='../icloud/del.php?del={$hash}'>del</a></div>";
        }
        if($res == "jpg"){
            //echo $res."<br>";
            echo "<div><a href='../icloud/download.php?file={$hash}'><img width='80px' height='80px' src='../users_file/root/{$string}'></img></a>";
